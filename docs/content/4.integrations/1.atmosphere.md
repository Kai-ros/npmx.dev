...
_npmx.dev_ site architecture as it pertains to the AT Protocol (atproto) ecosystem, the [Atmosphere](https://atproto.com/).

---

## Atmosphere

The Atmosphere is an interconnected web of applications that store or access data using atproto. The primary benefits of this integration for _npmx.dev_ are the social features that connect us to the tens of millions of users on the atproto social graph. Per the docs site:
...
- **AT Protocol Docs** - [Introduction](https://atproto.com)
